class Bird {
  constructor(x, y, lifespan = 300) {
    ...
    this.lastPosition = this.position.copy(); // Stores the last position

    this.lastPosition.x += random(-5, 5);
    this.lastPosition.y += random(-5, 5);
  ...
  render() {
    if (this.alive) {
      ...
      stroke(200,90);  // 200,50
      //stroke('#38bdf844')
      //if(random()<0.24) stroke('#7dd3fc');
      if(random()<0.05) stroke('#a5f3fc44')
